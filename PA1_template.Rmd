...
```{r}
actMerge$wkday <- factor(
  ifelse(isWeekday(actMerge$date), paste('weekday'), paste('weekend') ))
```  
...
The patterns were very similar with negligible differeces even though actual step counts were different.